...
To insert pixels in this updated format, we recommend using this plugin: https://wordpress.org/plugins/pixel-cat/. In addition to inserting the base pixel code on all pages, it also has Standard Events and WooCommerce support.
